...
export default function L2_Screen3_1() {
  ...
  return (
    <div style={{
      /* ĐÂY LÀ DÒNG FIX LỖI KHOẢNG TRẮNG:
         - flex: 1 giúp container tự động đẩy dài ra theo nội dung
         - minHeight: '100%' đảm bảo luôn lấp đầy màn hình kể cả khi ít nội dung */
      flex: 1, 
      width: '100%',
      minHeight: '100%', 
      display: 'flex', 
      ...
      {/* Tiêu đề & Lời thoại */}
      <div style={{ textAlign: 'center', maxWidth: '750px', marginBottom: '25px', paddingLeft: '50px' }}>
